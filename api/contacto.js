...
module.exports=async(req,res)=>{
  ...
  try{
    ...
    await transporter.sendMail({
      from:`"GameFix" <${process.env.SMTP_USER}>`,
      to:process.env.CONTACT_EMAIL||process.env.SMTP_USER,
      replyTo:email,
      subject:"Nueva consulta GameFix - gamefix.com.es",
      text:`Nueva consulta GameFix

Nombre: ${nombre}
Teléfono: ${telefono}
Email: ${email}
Consola/equipo: ${equipo}
...
${mensaje}`
    ...
    console.error("GameFix SMTP error",{
